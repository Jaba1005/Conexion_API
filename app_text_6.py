...
#peticion_usuario = 'Usuario: "Registra en la base de datos a los siguientes usuarios: Alejandro Barrera, Sofia Riofrio, Santiago Herrera y Esteban Rengifo"' #
peticion_usuario = 'Usuario: "No puedo entrar a mi cuenta"'
